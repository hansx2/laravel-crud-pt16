<html>
    ...
    <body class="p-8">
         ...
         <button onclick="toggle_modal()" class="bg-blue-500 text-white px-4 rounded-2xl">+ Tambah Item</button>
                    ...
                    <tr>
                        ...
                        <td class="border p-2 text-center">
                            <div class="flex items-center justify-center gap-4">
                                <button onclick='toggle_edit(@json($p))' class="text-green-500 font-medium">
                                    <span class="material-icons">edit</span>
                                </button>

                                <button onclick="if(confirm('Yakin ingin menghapus {{ $p->nama_barang }} ini?')) { document.getElementById('form-delete{{ $p->id }}').submit(); }" class="text-red-500 font-medium">
         ...
         <script>
                ...
                function toggle_edit(item) {
                    ...
                    //mengatur value input form dengan data yang dipilih:
